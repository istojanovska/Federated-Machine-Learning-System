...
BASE_PATH = r"C:\Users\User\Downloads\FederatedLearningParalel\app2\datasets"
...
def blocking_train(globalWeights: ModelWeights) -> ModelWeights:
    if globalWeights.modelTypeId == 0:
        CSV_PATH = os.path.join(BASE_PATH, "diabetes2.csv")
        FEATURES = ['Pregnancies', 'Glucose', 'BloodPressure', 'SkinThickness', 'Insulin', 'BMI', 'DiabetesPedigreeFunction', 'Age']
        TARGET = 'Outcome'

    elif globalWeights.modelTypeId == 1:
        CSV_PATH = os.path.join(BASE_PATH, "anemia2.csv")
        FEATURES = ['Gender', 'Hemoglobin', 'MCH', 'MCHC', 'MCV']
        TARGET = 'Result'

    elif globalWeights.modelTypeId == 2:
        CSV_PATH = os.path.join(BASE_PATH, "heart_attack2.csv")
